<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerManager.aspx.cs" Inherits="Admin_CustomerManager" Title="Untitled Page" %>
...
<asp:GridView ID="GridView1" runat="server" CssClass="GridBody" DataKeyNames="Id" AutoGenerateColumns="False" BackColor="White" DataSourceID="ObjectDataSource1" Width="95%" AllowPaging="True" OnRowDataBound="GridView1_RowDataBound">
    <Columns>
        ...
        <asp:TemplateField HeaderText="姓名" SortExpression="LoginId">
            <EditItemTemplate>
        ...
        <asp:TemplateField HeaderText="卡类型" SortExpression="Name">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox5" runat="server" Text='<%# Eval("Card.Name") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="Label5" runat="server" Text='<%# Eval("Card.Name") %>'></asp:Label>
            </ItemTemplate>            
            <HeaderStyle CssClass="GridHead" />
        </asp:TemplateField>
        
        <asp:TemplateField HeaderText="上线次数" SortExpression="LineCount">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox6" runat="server" Text='<%# Eval("LineCount") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="Label6" runat="server" Text='<%# Eval("LineCount") %>'></asp:Label>
            </ItemTemplate>           
            <HeaderStyle CssClass="GridHead" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="详细">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("Id", "CustomerById.aspx?id={0}") %>'
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetCustomerAll"
    TypeName="Hotel.BLL.CustomerBLL" DeleteMethod="DeleteById">
    <DeleteParameters>
