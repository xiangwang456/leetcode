<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="BillToOwnAdd.aspx.cs" Inherits="Admin_BillToOwn" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    { 
        ...
        if(document.getElementById("<%=txtRepairCause.ClientID%>").value.length<10)
        {
            alert("自用原因不能少于10个字");
                ...
                <tr>
                    ...
                    <td style="width: 780px; height: 440px; background-color: #f1f5f4;" valign="top"><%--450--%>
                        ...
                        <table width="100%">
                            <tr>
                                <td align="center">
                                    <span style="font-size:15px; font-family:楷体_GB2312">房间自用单</span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <!--结算信息-->
                        <table border="1" id="Table1" cellpadding="0" cellspacing="0" style="width: 99%; height: 25px;">                           
                           <tr>
                        ...
                        <table  cellpadding="0" cellspacing="0" style="width: 99%; height: 25px;">
                            <tr>
                                <td align="center">
                                    <asp:Button ID="Button3" runat="server" Text="确定登记" CssClass="btn" OnClientClick="return CheckForm();" OnClick="Button3_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
