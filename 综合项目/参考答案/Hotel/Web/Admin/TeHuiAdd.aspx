<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="TeHuiAdd.aspx.cs" ValidateRequest="false" Inherits="Admin_TeHuiAdd" Title="Untitled Page" %>
...
<br />
    <fieldset  style=" width:95%">
        <table width="90%" style="background-color:White">
            <tr>
                <td width="100px" align="right">特惠标题：
                </td>
                <td align="left">
            ...
            <tr>
                <td width="100px" align="right">特惠内容：
                </td>
                <td align="left" nowrap="nowrap">
                    <FTB:FreeTextBox ID="txtContent" runat="server" Height="250">
                    </FTB:FreeTextBox>
                    <asp:RequiredFieldValidator ID="rfvtxtContent" ControlToValidate="txtContent" runat="server" ErrorMessage="请输入特惠内容"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
