<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="BillToOwnById.aspx.cs" Inherits="Admin_BillToOwnById" Title="Untitled Page" %>
...
<asp:Panel id="pnlOk" runat="server" Width="700px" Height="200px" Visible="false">
    ...
    <FIELDSET style="WIDTH: 300px">
        <TABLE width="100%">
            <TBODY><TR>
                    <TD style="FONT-WEIGHT: 100; FONT-SIZE: 14px" align=left>
