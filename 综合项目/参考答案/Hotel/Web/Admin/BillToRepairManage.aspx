<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="BillToRepairManage.aspx.cs" Inherits="Admin_BillToRepairManage" Title="Untitled Page" %>
...
<br />
    <asp:GridView ID="GridView1"  CssClass="GridBody" runat="server" BackColor="White" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" Width="95%" AllowPaging="True" OnRowDataBound="GridView1_RowDataBound">
        <Columns>
            ...
            <asp:BoundField DataField="RepairId" HeaderText="RepairId" SortExpression="RepairId" Visible="False" />
        ...
        <asp:TemplateField HeaderText="详细">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("RepairId", "BillToRepairById.aspx?id={0}") %>'
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAll"
        TypeName="Hotel.BLL.BillToRepairBLL"></asp:ObjectDataSource>
</asp:Content>
